  ...
  return (
    <View style={styles.root}>
      ...
      <CustomInput
        ...
        name="email"
          control={control}
          rules={{required:'Email is not empty', pattern: {value: EMAIL_REGEX},message:'Email is invalid'}}
      />
      <CustomInput
      ...
      <Text style={styles.text}>By registering, you confirm that you are accpect our{''}<Text style={styles.link} onPress={OnTermsOfUsePressed}> Terms of Use</Text> and <Text style={styles.link} onPress={OnPrivacyPressed}>Privacy Policy</Text></Text>
    <SocialSignInButton/>
    </View>
  );
};
